...
const T_OPEN = 1.9 // seconds before the drapes start to part
const D_OPEN = 1.3 // how long the drawing-apart takes
...
function Valance() {
  return (
    <motion.div
      ...
      initial={{ y: '0%' }}
      animate={{ y: '-130%' }}
      transition={{ delay: T_OPEN + 0.55, duration: 0.75, ease: OPEN_EASE }}
    >
      {/* curtain rod */}
      <div
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden">
      ...
      <motion.div
        ...
        transition={{ duration: T_OPEN, times: [0, 0.24, 0.78, 1], ease: 'easeInOut' }}
      >
        <img
